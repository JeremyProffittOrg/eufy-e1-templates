...
plate = [318.000, 86.000, 4.400];
base_z = 2.000;
wall = 2.000;
corner_r = 3.000;
pocket_r = 0.800;
pick_r = 4.500;
label = "Mini bed — 72-pin SIMM";
part_key = "mini-simm72";

pockets = [
    [49.550, 2.150, 108.450, 25.900, 2.400],
    [160.000, 2.150, 108.450, 25.900, 2.400],
    [49.550, 30.050, 108.450, 25.900, 2.400],
    [160.000, 30.050, 108.450, 25.900, 2.400],
    [49.550, 57.950, 108.450, 25.900, 2.400],
    [160.000, 57.950, 108.450, 25.900, 2.400]
];
